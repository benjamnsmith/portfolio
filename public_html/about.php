    ...
    <section id="content">
        <div class="col1">
            <p>&emsp;&emsp;&emsp;&emsp;I'm Ben, a computer systems student at the University of Minnesota - Twin Cities. I'm fascinated 
                ...
                technology is essential, and I'm passionate about exploring recent developments in computer security through sources 
            ...
            <p>&emsp;&emsp;&emsp;&emsp;Aside from my studies, I enjoy learning about different cultures and languages. I speak Russian 
                and French and had the chance to teach English to elementary school students during my time studying in Montpellier, France 
                during Fall 2022.
            </p>
            
            <p>
                &emsp;&emsp;&emsp;&emsp;As an undergraduate teaching assistant, I create and run weekly labs for upperclassmen computer science minors 
                and MIS students on topics around computer systems focusing on C, x86_64, and memory management. I also volunteer with the Hennepin County 
        ...
        <div class="col2">
            ...
            I'm interested in any programming language that allows me to hack together what I'm looking to achieve. I mostly use <span>Python</span>,
             but recently have been intrigued by <span>JavaScript</span>. 
                This website is written almost completely in <span>PHP</span>. I'm "classially trained," as it were, in <span>C</span>. 
                <br>
                <br>
